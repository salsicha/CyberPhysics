...
'''
Oak-1 camera default IP is 169.254.1.222
Ensure your machine is set to the correct subnet to view the device from the drop down
OR
Manually specify the device IP
'''
