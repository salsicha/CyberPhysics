...
def generate_launch_description():
    args = [
        ...
        ('odometry_output_topic', '/mapnav/odometry',  'Output metric odometry topic'),
        ('pose_output_topic', '/mapnav/pose',           'Output metric pose topic'),
        ('metric_depth_topic', '/mapnav/metric_depth',  'Output metric depth image'),
        ('pointcloud_topic', '/mapnav/points',          'Output metric point cloud'),
        ('confidence_topic', '/mapnav/confidence',      'Terrain match confidence'),
        ('scale_topic', '/mapnav/depth_scale',          'Relative-to-metric depth scale'),
        ('valid_topic', '/mapnav/valid',                'Whether the latest match is valid'),
