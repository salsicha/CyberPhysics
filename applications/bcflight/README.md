...
This app serves as a demonstration for BCFlight. This version has been forked and contains a different hardware configuration.

See original project:
https://github.com/dridri/bcflight
